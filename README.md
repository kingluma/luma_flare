...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/luma-flare)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/luma-flare
```

A live public deployment of this template is available at [https://luma-flare.templates.workers.dev](https://luma-flare.templates.workers.dev)
